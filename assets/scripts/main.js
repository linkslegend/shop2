...
$(".featured2").slick({
  ...
  responsive: [
      ...
      {breakpoint: 880, settings: {slidesToShow: 2, infinite: true}},
...
$(".single-featured3").slick({
  ...
  // the magic
  	responsive: [
  	  {breakpoint: 1250, settings: {slidesToShow: 5, infinite: true}},
  	  {breakpoint: 991, settings: {slidesToShow: 4, infinite: true}},
      {breakpoint: 769, settings: {slidesToShow: 3, infinite: true}},
      {breakpoint: 600, settings: {slidesToShow: 2, infinite: true}}
    ]
});
