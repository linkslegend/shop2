...
if ( $max_value && $min_value === $max_value ) {
	...
	<div class="quantity">
		...
		<button class="step-btn minus" type="button" value="-"><i class="fa fa-minus" aria-hidden="true"></i></button>
		...
		<button class="step-btn plus" type="button" value="+"><i class="fa fa-plus" aria-hidden="true"></i></button>
	</div>
	<?php
}
